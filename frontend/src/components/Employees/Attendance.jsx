      ...
      <section className="section">
              <div className="card">
                <div className="card-header d-flex justify-content-between">
                  <h4>Attendance</h4>
                  <button  className={`btn btn-lg ${isAttendanceMarked?"btn-secondary":"btn-warning"} btn-icon-split`} onClick={markAttendance}>{isAttendanceMarked?"Attendance Marked":"Mark Attendance"}</button>
                </div>
              </div>
        ...
        <button onClick={searchAttendance} className="btn btn-lg btn-warning col">Search</button>
      </div>
      </section>
